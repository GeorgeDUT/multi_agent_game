...
About WarMap2
red surround a blue, blue remove, no blue on board, red win.
    ...
    def fight(self):
        ...
        for i in range(self.blue_num):
            ...
            if blue_enemy==4:
                ...
                if self.blue_army[i].x*self.blue_army[i].y==0:
                    self.blue_army[i].win_p = 0
                elif self.blue_army[i].x==self.map_w-1 or self.blue_army[i].y==self.map_h-1:
                    self.blue_army[i].win_p = 0
            elif blue_enemy==2:
                if self.blue_army[i].x==0 and self.blue_army[i].y==0:
                    self.blue_army[i].win_p = 0
                elif self.blue_army[i].x==self.map_w-1 and self.blue_army[i].y==self.map_h-1:
                    self.blue_army[i].win_p = 0
                elif self.blue_army[i].x==0 and self.blue_army[i].y==self.map_h-1:
                    self.blue_army[i].win_p=0
